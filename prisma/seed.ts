...
async function main() {
  ...
  // Video URL (temporary)
  const VIDEO_URL =
    "https://j3z8y187h5.ufs.sh/f/8QlRmO7DVzRtgmJvjYrtePmGcpKlCr15oHqO78uwTnVQk6fD";
  ...
  const lesson1Questions = [
        ...
        },
        {
          id: "q4",
          question:
            "A synonym is basically a word that implies something similar to the provided word.",
          options: [
            { label: "A", text: "true" },
            { label: "B", text: "false" },
            { label: "C", text: "maybe" },
        ...
        },
        {
          ...
          options: [
            {
              label: "A",
              text: "To confuse readers with too many word choices",
            },
            { label: "B", text: "To make writing longer and more complicated" },
            {
              label: "C",
              text: "To improve vocabulary, avoid repetition, and make text more engaging",
            },
            {
              label: "D",
              text: "To replace all simple words with difficult ones",
            },
          ],
          correctAnswer: "C",
        },
        {
          id: "q8",
          question:
            "Which of the following statements about synonyms is NOT correct?",
          options: [
            {
              label: "A",
              text: "Synonym allows language to become more expressive and appealing.",
            },
            {
              label: "B",
              text: "Synonym helps prevent text from being monotonous.",
            },
            {
              label: "C",
              text: "Synonym helps learners expand their vocabulary and understanding.",
            },
            {
              label: "D",
              text: "Synonyms always make sentences shorter and simpler.",
            },
          ],
          correctAnswer: "D",
        },
        ...
        },
        {
          id: "q12",
          question:
            '"Peter is a very handsome man, so a <u>lot</u> of people admire him." What is the synonym for the underlined word?',
          options: [
            { label: "A", text: "few" },
            { label: "B", text: "many" },
        ...
        },
        {
          ...
          options: [
            ...
            {
              label: "C",
              text: "Their house is very cozy and comfortable to live in.",
            },
            { label: "D", text: "All of the above" },
          ],
          correctAnswer: "C",
        },
        {
          ...
          options: [
            {
              label: "A",
              text: "The movie was exciting and thrilling from start to finish.",
            },
            {
              label: "B",
              text: "The juice was sweet and bitter, but everyone liked it.",
            },
        ...
        },
        {
          ...
          options: [
            {
              label: "A",
              text: "The book was interesting and boring at the same time.",
            },
            {
              label: "B",
              text: "His explanation was clear and understandable to everyone.",
            },
            {
              label: "C",
              text: "The road was narrow and bumpy, making it hard to drive.",
            },
            { label: "D", text: "None of the above" },
          ],
          correctAnswer: "B",
  ...
  const lesson2Questions = [
        {
          id: "q1",
          question:
            "According to Cambridge Dictionary, collocations are word pairs that…",
          options: [
            { label: "A", text: "are only used in academic English." },
            {
              label: "B",
              text: "sound correct to native speakers when used together.",
            },
        ...
        },
        {
          ...
          options: [
            {
              label: "A",
              text: "They make English sentences longer and more complex.",
            },
            { label: "B", text: "They remove the need to learn grammar." },
            {
              label: "C",
              text: "They help create smoother, clearer, and more professional writing.",
            },
        ...
        },
        {
          id: "q3",
          question:
            "Which sentence shows how collocations make writing more precise or expressive?",
          options: [
            { label: "A", text: "It was very cold and very dark outside." },
            { label: "B", text: "It was coldly cold and darkly dark outside." },
            {
              label: "C",
              text: "It was bitterly cold and pitch dark outside.",
            },
            {
              label: "D",
              text: "It was cold, dark, and confusing to describe.",
            },
          ],
          correctAnswer: "C",
        },
        {
          ...
          options: [
            ...
            {
              label: "B",
              text: "A fixed phrase whose meaning cannot be guessed from the separate words.",
            },
            {
              label: "C",
              text: "Words that can replace each other without changing the meaning.",
            },
            {
              label: "D",
              text: "Words that often go together naturally in English.",
            },
          ],
          correctAnswer: "D",
        },
        {
          ...
          options: [
            ...
            {
              label: "B",
              text: "They begin to memorize individual words instead of meaningful chunks.",
            },
            {
              label: "C",
              text: "They rely mainly on grammar rules rather than vocabulary patterns.",
            },
            {
              label: "D",
              text: "They often create unusual word pairings that sound less natural.",
            },
          ],
          correctAnswer: "A",
        },
        {
          id: "q6",
          question:
            'The collocation "make a decision" is an example of which type?',
          options: [
        ...
        },
        {
          id: "q7",
          question:
            'The collocation "deeply disappointed" is an example of which type?',
          options: [
            { label: "A", text: "Verb + Noun" },
            { label: "B", text: "Noun + Noun" },
            { label: "C", text: "Verb + Adverb" },
        ...
        },
        {
          id: "q8",
          question:
            'The collocation "family member" is an example of which type?',
          options: [
            { label: "A", text: "Verb + Noun" },
            { label: "B", text: "Noun + Noun" },
            { label: "C", text: "Verb + Adverb" },
        ...
        },
        {
          id: "q9",
          question:
            'The collocation "tread carefully" is an example of which type?',
          options: [
        ...
        },
        {
          id: "q10",
          question:
            'The collocation "a key factor" is an example of which type?',
          options: [
            { label: "A", text: "Adjective + Noun" },
            { label: "B", text: "Noun + Noun" },
            { label: "C", text: "Verb + Adverb" },
        ...
        },
        {
          id: "q11",
          question:
            "Ilor and his friends must focus _____ improving their vocabulary.",
          options: [
            { label: "A", text: "under" },
            { label: "B", text: "for" },
            { label: "C", text: "in" },
        ...
        },
        {
          id: "q12",
          question:
            "The new learning website is highly _____ by many teachers and schools.",
          options: [
            { label: "A", text: "broken" },
        ...
        },
        {
          id: "q13",
          question:
            "Rommel believes that hard work is _____ in achieving success.",
          options: [
  ...
  const lesson3 = await prisma.videoLesson.upsert({
    ...
    update: {
      ...
      videoUrl:
        "https://j3z8y187h5.ufs.sh/f/8QlRmO7DVzRtuVN2FpEpY5V6xKCBSaOQXnZG7UFimTkJEoNc",
      duration: 210,
    },
    create: {
      title: "Word Parts: Roots, Prefixes and Suffixes",
  ...
  const lesson3Questions = [
        ...
        },
        {
          id: "q3",
          question:
            "Which sentence correctly uses the meaning of a prefix to infer the word's meaning?",
          options: [
            {
              label: "A",
              text: "He rewrote the essay, meaning he wrote it for the first time.",
            },
            {
              label: "B",
              text: "The preview was confusing because it came after the full film.",
            },
            { label: "C", text: "The subway travels under the city." },
            {
              label: "D",
              text: "She misheard the instructions, meaning she heard them correctly.",
            },
          ],
          correctAnswer: "C",
        },
        ...
        },
        {
          id: "q6",
          question:
            "Which word uses one of the four most common prefixes in English (un-, re-, dis-, in-/im-/il-/ir-)?",
          options: [
        ...
        },
        {
          id: "q8",
          question:
            "Which of the following contains two affixes (a prefix and a suffix)?",
          options: [
        ...
        },
        {
          id: "q9",
          question:
            "Which word demonstrates that prefixes usually do NOT change part of speech?",
          options: [
        ...
        },
        {
          id: "q11",
          question:
            "Which explains why word parts help with vocabulary retention?",
          options: [
            { label: "A", text: "Because all affixes have identical meanings" },
            {
              label: "B",
              text: "Because seeing related word forms counts as repeated exposure",
            },
            {
              label: "C",
              text: "Because every word with a suffix becomes a new word",
            },
            {
              label: "D",
              text: "Because prefixes always change part of speech",
            },
          ],
          correctAnswer: "B",
        },
        ...
        },
        {
          ...
          options: [
            ...
            {
              label: "C",
              text: "Adding -er to teach creates a noun meaning a person who teaches.",
            },
        ...
        },
        {
          id: "q14",
          question:
            "Which of the following is an example of a word made only through inflection, not derivation?",
          options: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              label: "B",
              text: "The prefix makes the meaning opposite or negative.",
            },
